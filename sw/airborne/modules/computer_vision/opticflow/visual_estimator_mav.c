...
// Computer Vision
#include "opticflow/optic_flow_int.h" // Change name?
...
//REMOVED_MAV   results->Vely = 0.0;
  ...
  results->cnt = 0;
  results->count = 0;
//ADD the Total flow: results->OFtotal
//ADD the Total flow left: results->OFtotalL
//ADD the Total flow right: results->OFtotalR
//ADD the Featureless zone: results->OFFlessZone
...
// Change dy_sum to dy, and loop over the dy array.
